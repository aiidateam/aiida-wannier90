...
wannier90_parameters = ParameterData(dict={'bands_plot':False,
                                'num_iter': 12,
...
wc = submit(SimpleWannier90WorkChain,
       ...
       #orbital_projections=projections,
        ...
        mlwf={'projections':projections, 'parameters':wannier90_parameters},
        matrices={},#'_options':pw2wannier90_options},
        restart_options = {'scf_workchain':load_node(712),'nscf_workchain':load_node(776),'mlwf_pp':load_node(1256)},
    )
