...
if __name__ == "__main__":  # noqa
    ...
    try:
        ...
        print(("Must provide as second parameter the main code"),
              file=sys.stderr)
        sys.exit(1)
    ...
    if not do_preprocess:
        try:
            ...
            print(
                "A node with pk={} does not exist".format(input_folder_pk),
                file=sys.stderr
            )
            sys.exit(1)
    ...
    if submit_test:
        ...
        calc = submit(builder)
        print(
            "submitted calculation; calc=Calculation(uuid='{}') # ID={}".
            format(calc.uuid, calc.pk)
        )
